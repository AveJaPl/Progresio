...
export default function ProgressDetailsBoolean({ progress }: ProgressDetailsBooleanProps) {
  return (
    <div className="max-w-xl mx-auto mt-8">
      <h2 className="text-lg font-semibold mb-4 text-gray-800">Progress (Boolean)</h2>
        ...
        <tbody>
          {progress.map((item) => (
            <tr key={item.id} className="border-b hover:bg-gray-50 transition">
              ...
              <td className={`p-3 font-semibold ${item.value === 'true' ? 'text-blue-600' : 'text-red-600'}`}>
